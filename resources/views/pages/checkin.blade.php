...
<div class="page-header no-margin-bottom">
    ...
    <h2 class="h5 no-margin-bottom">เช็คอิน</h2>
    </div>
</div>
<!-- Breadcrumb-->
<div class="container-fluid">
    ...
    <li class="breadcrumb-item active">เช็คอิน</li>
    </ul>
</div>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="building" id="building">
                                    @foreach($buildinglist as $key=>$value)
                                        @if($B_flag["B_".$value->building_id])
                ...
                <div class="block">
                    ...
                    <div class="block-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="recept_name" name="recept_name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8 ml-auto">
                            ...
                            <a href="checkin" class="btn btn-secondary">ยกเลิก</a>
                        </div>
                    </div>
                </div>
            </div>
