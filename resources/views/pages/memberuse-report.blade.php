...
@section('title')
รายงานการใช้สิทธิ์เมมเบอร์
@stop
@section('content')
    <div id="page-menu-key" data-menu="m_report" data-sub="report_ddl" data-url="memberuse" ></div>
    <!-- Page Header-->
    <div class="page-header no-margin-bottom">
        <div class="container-fluid">
        <h2 class="h5 no-margin-bottom">รายงานการใช้สิทธิ์เมมเบอร์</h2>
        </div>
    </div>
    <!-- Breadcrumb-->
    <div class="container-fluid">
        ...
        <li class="breadcrumb-item active">รายงานการใช้สิทธิ์เมมเบอร์</li>
        </ul>
    </div>
                        ...
                        <div class="col-md-4">
                            <div class="block-body">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <a id="link_print" href="javascript:void(0);" target="_blank" class="btn btn-info"><i class="fa fa-print"></i> พิมพ์เอกสาร</a>
...
function chooseDate(){
    console.log("trigger !");
    $("#link_print").attr("href","{{Config::get('app.context')}}report/memberuse-print?start="+$("#dpd1").parents(".input-group").find("input").val()+"&end="+$("#dpd2").parents(".input-group").find("input").val()+"&building="+$("#sl-building").val());
}
</script>
@stop
